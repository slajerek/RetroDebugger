/** \file   machinepowerfrequencywidget.h
 * \brief   Machine power frequency selection widget - header
...
#ifndef VICE_MACHINEPOWERFREQUENCYWIDGET_H
#define VICE_MACHINEPOWERFREQUENCYWIDGET_H
