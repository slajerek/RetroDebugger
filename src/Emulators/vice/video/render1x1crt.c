...
/* NTSC 1x1 renderers */
static inline void
render_generic_1x1_crt(video_render_color_tables_t *color_tab, const BYTE *src, BYTE *trg,
...
void
render_16_1x1_crt(video_render_color_tables_t *color_tab,
                   const BYTE *src, BYTE *trg,
                   const unsigned int width, const unsigned int height,
                   const unsigned int xs, const unsigned int ys,
                   const unsigned int xt, const unsigned int yt,
...
void
render_24_1x1_crt(video_render_color_tables_t *color_tab,
                   const BYTE *src, BYTE *trg,
                   const unsigned int width, const unsigned int height,
                   const unsigned int xs, const unsigned int ys,
                   const unsigned int xt, const unsigned int yt,
