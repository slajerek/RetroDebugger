 ...
 */
/*
 * menu_vic20cart.h - Implementation of the vic20 cartridge settings menu for the SDL UI.
 *
 * Written by
...
#ifndef VICE_UIMENU_VIC20CART_H
#define VICE_UIMENU_VIC20CART_H

#include "vice.h"

#include "uimenu.h"

extern const ui_menu_entry_t vic20cart_menu[];
