#ifndef _CViewC64ColorRamScreen_h_
#define _CViewC64ColorRamScreen_h_

#include "CGuiView.h"

class CViewC64ColorRamScreen : public CGuiView
{
public:
	CViewC64ColorRamScreen(const char *name, float posX, float posY, float posZ, float sizeX, float sizeY);
	virtual ~CViewC64ColorRamScreen();
