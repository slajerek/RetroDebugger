...
CViewDrive1541StateCPU::CViewDrive1541StateCPU(const char *name, float posX, float posY, float posZ, float sizeX, float sizeY, CDebugInterfaceC64 *debugInterface)
...
void CViewDrive1541StateCPU::RenderRegisters()
{
	float px = this->posX;
	float py = this->posY;
...
void CViewDrive1541StateCPU::SetRegisterValue(StateCPURegister reg, int value)
{
...
int CViewDrive1541StateCPU::GetRegisterValue(StateCPURegister reg)
{
