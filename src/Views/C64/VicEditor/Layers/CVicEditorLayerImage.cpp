...
CVicEditorLayerImage::CVicEditorLayerImage(CViewC64VicEditor *vicEditor, char *layerName)
...
bool CVicEditorLayerImage::GetColorAtPixel(int x, int y, u8 *color)
{
	...
	*color = FindC64Color(r, g, b, vicEditor->debugInterface);
...
void CVicEditorLayerImage::Serialize(CByteBuffer *byteBuffer)
{
...
void CVicEditorLayerImage::Deserialize(CByteBuffer *byteBuffer, int version)
{
	if (version < 3)
	{
