...
CVicEditorLayerVirtualSprites::CVicEditorLayerVirtualSprites(CViewC64VicEditor *vicEditor)
...
{
	showSpriteGrid = vicEditor->viewVicDisplay->showGridLines;
	RenderGrid(viciiState, vicEditor->viewVicDisplay);
}
...
{
	LOGError("CVicEditorLayerVirtualSprites::RenderGridPreview not implemented");
...
void CVicEditorLayerVirtualSprites::Serialize(CByteBuffer *byteBuffer)
{
	guiMain->LockMutex(); //"CVicEditorLayerVirtualSprites::Serialize");
		 ...
		 it != this->sprites.end(); it++)
	{
		...
		sprite->Serialize(byteBuffer);
	}
	
	guiMain->UnlockMutex(); //"CVicEditorLayerVirtualSprites::Serialize");
}

void CVicEditorLayerVirtualSprites::Deserialize(CByteBuffer *byteBuffer, int version)
{
