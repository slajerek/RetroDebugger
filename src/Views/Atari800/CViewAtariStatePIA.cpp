...
void CViewAtariStatePIA::SetPosition(float posX, float posY, float posZ, float sizeX, float sizeY)
{
	...
	{
		// Auto-scale: 26 chars wide, 5 rows tall
		fontSize = fmin(sizeX / 26.0f, sizeY / 5.0f);
...
void CViewAtariStatePIA::LayoutParameterChanged(CLayoutParameter *layoutParameter)
{
	...
	{
		float autoFontSize = fmin(sizeX / 26.0f, sizeY / 5.0f);
