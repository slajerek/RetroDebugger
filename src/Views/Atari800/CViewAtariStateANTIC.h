...
{
public:
	CViewAtariStateANTIC(const char *name, float posX, float posY, float posZ, float sizeX, float sizeY, CDebugInterfaceAtari *debugInterface);
	...
	float anticDisplayListScrollStartY;
	virtual bool DoScrollWheel(float deltaX, float deltaY);
	
	int anticDisplayListNumRenderedLines;
	void WrapDisplayListScroll();
