...
void PLUGIN_GalaxySetVisible(bool isVisible)
{
	if (pluginGalaxy != NULL)
	{
		pluginGalaxy->view->SetVisible(isVisible);
	}
}
...
//		}
	...
	//
	view->cartName = STRALLOC("GalaxyMarszruta");
	view->cartOutPath = STRALLOC("/Users/mars/develop/galaxy-marszruta/galaxy.crt");
	view->rootFolderPath = STRALLOC("/Users/mars/develop/galaxy-marszruta");
	view->buildFilePath = STRALLOC("");
	view->binFilesPath = STRALLOC("/Users/mars/develop/galaxy-marszruta/bin");
	view->exoFilesPath = STRALLOC("/Users/mars/develop/galaxy-marszruta/exo");
	view->exomizerPath = STRALLOC("/Users/mars/develop/lukhash/tools/exomizer310/src/exomizer");
	view->exomizerParams = STRALLOC("-B -M256");
	view->javaPath = STRALLOC("/usr/bin/java");
	view->kickAssJarPath = STRALLOC("/Users/mars/develop/lukhash/tools/KickAss.jar");
	view->kickAssParams = STRALLOC("-odir /Users/mars/develop/galaxy-marszruta/bin -showmem -debugdump");
//	view->decrunchBinPath = STRALLOC("/Users/mars/develop/lukhash/tools/exomizer310/exodecrs/decrunch.bin");
	view->decrunchBinPath = STRALLOC("/Users/mars/develop/galaxy-marszruta/tools/exomizer310/exodecrs/decrunch.bin");
	view->decrunchBinStartAddr = 0x7E00;

	CCrtMakerFile *dataFile = new CCrtMakerFile("/Users/mars/develop/galaxy-marszruta/prg/main.prg", "main.prg");
	view->AddFile(dataFile);
...
//	A("				JMP *");
	...
	view->ProcessFiles();
	view->MakeCartridge();
	viewC64->viewC64MainMenu->InsertCartridge(new CSlrString(view->cartOutPath), false);
