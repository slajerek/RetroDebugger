...
class C64DebuggerPluginCommando : public CDebuggerEmulatorPluginVice, public CGuiView, CSlrThread,
CGuiButtonCallback, CGuiViewMenuCallback, CSystemFileDialogCallback, CFeatureConfig
{
public:
	C64DebuggerPluginCommando(float posX, float posY, float posZ, float sizeX, float sizeY);
	virtual ~C64DebuggerPluginCommando();
